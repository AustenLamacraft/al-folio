...
I wrote the following as a preamble to my [fourth year course](http://tqm.courses.phy.cam.ac.uk/) on many body physics. It's a short manifesto for us 'emergents' -- the part of condensed matter that doesn't do first principles calculations -- to try to explain why thinking about hugely simplified models is a fruitful endeavour and not (as Adam Nahum once put it to me) "a really complicated board game".

## Models of Matter

The purpose of this course is to introduce __simple models__ of phenomena in condensed matter physics, and to equip you with the tools needed to analyse their behaviour.
